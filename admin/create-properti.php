...
(room_number, room_type_id, gender_type, price, facilities, area_size, is_electric_included, is_water_included, room_rules, rating, status) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil disimpan'); window.location='list-properti.php';</script>";
    } else {
        ...
        <div class="w-full max-w-2xl">
            ...
            <form method="POST" action="" class="bg-white shadow-md rounded-lg p-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" placeholder="Contoh : 350000" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" name="price" required>
                </div>

                <div class="mb-4">
                    <label class="block text-gray-700 font-semibold mb-2">Fasilitas</label>
                    <input type="text" placeholder="Contoh : Bed, Lemari, Meja Belajar" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" name="facilities" required>
                </div>

                <div class="mb-4">
                    <label class="block text-gray-700 font-semibold mb-2">Ukuran Kamar (m)</label>
                    <input type="text" placeholder="Contoh : 4x6" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" name="area_size" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" name="room_rules" rows="4"></textarea>
                </div>
